    ...
    <>
      <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left">
        ...
        <div className="max-w-xl z-10 text-gray-500">
          <h1 className="md:text-course-details-heading-large text-course-details-heading-small font-semibld text-gray-800">
        ...
        {/* right-column */}
        <div className="max-w-course-card z-10 shadow-custom-card rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:win-w-[420px] ">
          {playerData ? (
            <YouTube
            ...
            <div className="flex items-center text-sm md:text-default gap-4 pt-2 md:pt-4 text-gray-500 ">
              ...
              <div className="flex items-center gap-1">
                ...
                <p>
                  ...
                  {calculateNoOfLectures(courseData) > 1 ? "lessons" : "lesson"}
                </p>
              </div>
            </div>
